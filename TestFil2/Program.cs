...
static class ExamUtils
{
    ...
    public static async Task WaitRemainingTasksAsync(params Task[] tasks)
    {
...
class Program
{
    static async Task A()
    {
        ...
        catch (Exception)
        {
            ...
            // IsCompletedSuccessfully: True only when the task completed
            // without faulting or being canceled.
        ...
        await ExamUtils.WaitRemainingTasksAsync(task1, task2, task3);
    }
